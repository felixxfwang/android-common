...
public interface IConfigValue {
   ...
   *
   * @return {@link com.google.firebase.remoteconfig.FirebaseRemoteConfig#VALUE_SOURCE_REMOTE} if the value was retrieved from the
   *     server, {@link com.google.firebase.remoteconfig.FirebaseRemoteConfig#VALUE_SOURCE_DEFAULT} if the value was set as a
